...
class ApiConfig {
  ...
  // static const String _androidEmulatorBaseUrl = 'http://localhost:8000/api/';
  ...
  // static const String _localhostBaseUrl = 'http://localhost:8000/api/';
  ...
  // static const String _physicalDeviceBaseUrl = 'http://localhost:8000/api/';
